...
export default function App() {
  return (
    <div className="min-h-screen flex flex-col font-sans relative">
        ...
        <section className="relative pt-40 pb-20 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="relative z-10 aspect-square lg:aspect-square rounded-3xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-2xl max-w-2xl mx-auto">
                  <img 
      ...
      {/* Footer / Bottom Bar */}
      <footer className="py-10 px-6 border-t border-zinc-900 mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col md:row items-center justify-between gap-6">
          <p className="text-zinc-500 text-sm">
            © 2026 THE CODE HOUSE. ALL RIGHTS RESERVED.
          </p>
